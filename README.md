...
<head>
  ...
  <link rel="stylesheet" href="/sc/SuiteScripts/Teibto/ds/v1.45.1/tbt-theme.css">
  <script type="module" src="/sc/SuiteScripts/Teibto/ds/v1.45.1/index.js"></script>
</head>
<body>
  <tbt-app-shell>
...
```javascript
import { confirm } from '/sc/SuiteScripts/Teibto/ds/v1.45.1/tbt-confirm.js';
...
```javascript
import { showToast } from '/sc/SuiteScripts/Teibto/ds/v1.45.1/tbt-toast.js';
...
<script type="module">
  import { PO_SCHEMA } from '/sc/SuiteScripts/Teibto/ds/v1.45.1/tbt-doc-schemas.js';
...
```
/SuiteScripts/Teibto/ds/v1.45.1/
  tbt-theme.css
  index.js
  tbt-icons-css.js
...
```html
<link rel="stylesheet" href="/sc/SuiteScripts/Teibto/ds/v1.45.1/dist/tbt-theme.css">
<script type="module"  src="/sc/SuiteScripts/Teibto/ds/v1.45.1/dist/tbt-ds.min.js"></script>
```
...
suitecloud file:upload --paths "/SuiteScripts/Teibto/ds/v1.45.1/*"
```
